...
curl "https://raw.githubusercontent.com/kefyru/V8Lib/master/V8Lib/bin/Debug/VLib.dll" --create-dirs --output "%ProgramFiles%\1cv8\v8lib\VLib.dll"
curl "https://raw.githubusercontent.com/kefyru/V8Lib/master/V8Lib/bin/Debug/VLib.pdb" --create-dirs --output "%ProgramFiles%\1cv8\v8lib\VLib.pdb"
